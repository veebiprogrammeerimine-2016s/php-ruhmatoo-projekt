...
<head>
    ...
    <title>Muuda punkti tööajad</title>
...
<div class="container" style="margin-top:100px;">
    <div class="col-md-offset-2 col-md-8">
        <form method="post">
            ...
            <input type="submit" name="submit" class="btn btn-primary" id="confirm" value="MUUDA" />
...
function generateDates($dayNumber, $open) {
    ...
    while ($start !== $end) {
        ...
        if ($dayNumber == 0) {
            $value .= "<option class='0' style='display:none' value='".date('H:i:s', $start)."'>".date('H:i', $start)."</option>";
            $value .= "<option value='closed' selected disabled>Closed</option>";
            return $value;
        } else if ($dayNumber == 6) {
