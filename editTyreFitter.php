...
if (isset($_GET['id'])) {
    ...
    $name = $tyreFitting->name;
    $description = $tyreFitting->description;
    $logo = $tyreFitting->logo;
    $location = $tyreFitting->location;
    $priceList = $tyreFitting->pricelist;
}
...
if (isset($_POST['submit'])) {
    ...
    if ($formValid) {
        $fittingId = $TyreFitting->updateTyreFitter($id, $_POST['tyreFitterName'], $_POST['description'], $logo, $_POST['location'], $_POST['priceList'], $_SESSION['userId']);
        header("Location: tyre-fitter.php?id=".$id);
    }
...
<head>
    ...
    <title>Muuda rehvivahetus punkt</title>
...
<div class="container" style="margin-top:100px;">
    ...
    <div class="row">
        <div class="jumbotron col-md-offset-2 col-md-8">
            <h3 class="display-4">Muuda rehvivahetus punkt</h3>
            <hr class="my-4">
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tyreFitterName" placeholder="Sisesta nimetus" value="<?php echo $name; ?>"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="location" placeholder="Sisesta google maps link" value="<?php echo $location; ?>" />
                </div>

                <div class="form-group">
                    <p class="error"><?php echo $errorPriceList; ?></p>
                    <label for="priceList">Price list:</label>
                    <input type="text" class="form-control" name="priceList" placeholder="Sisesta hinna link" value="<?php echo $priceList; ?>"/>
                </div>
